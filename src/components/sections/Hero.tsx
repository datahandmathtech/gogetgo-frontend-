      ...
      <div className="container relative z-10 mx-auto px-6 h-full flex flex-col justify-center">
        <div className="text-center flex flex-col items-center">
          ...
          <KineticTitle 
            ...
            className="text-5xl md:text-8xl lg:text-[7.5rem] font-black text-white leading-[0.9] tracking-tighter mb-10 uppercase text-center justify-center font-serif"
            stagger={0.08}
          />
          ...
          >
            <Magnetic>
              <a href="tel:+917737737937" className="group relative bg-primary text-white px-12 py-6 rounded-full font-black text-sm uppercase tracking-[0.2em] flex items-center justify-center gap-3 overflow-hidden transition-all duration-500 hover:shadow-[0_0_40px_rgba(var(--color-primary),0.4)] hover:shadow-primary/40 active:scale-95">
