            ...
            <div className="bg-slate-950 rounded-3xl p-10 md:p-16 relative overflow-hidden text-center lg:text-left">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  ...
                  <a href="https://wa.me/918000505810" className="bg-white/10 backdrop-blur-md border border-white/20 text-white px-8 py-4 rounded-xl font-bold uppercase tracking-widest text-sm hover:bg-white/20 transition-colors flex items-center justify-center gap-2">
